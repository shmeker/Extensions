...
{
	/// <summary>
	/// Static class with methods to read data as bool.
	/// </summary>
	public static class BooleanExtensions
	{
		/// <summary>
		/// Extension method to get bool value from reader.
		/// </summary>
		...
		/// <returns>Value converted as bool if exists, null otherwise.</returns>
		...
		public static bool? GetBooleanNullable(this System.Data.Common.DbDataReader dbDataReader, int columnOrdinal)
		{
			...
			return dbDataReader.GetBoolean(columnOrdinal);
		}
		...
		public static bool? GetBooleanNullable(this System.Data.Common.DbDataReader dbDataReader, string columnName)
		{
			...
			return dbDataReader.GetBooleanNullable(columnOrdinal);
		}
	}
}
