...
{
	/// <summary>
	/// Static class with methods to read data as decimal.
	/// </summary>
	public static class DecimalExtensions
	{
		/// <summary>
		/// Extension method to get decimal value from reader.
		/// </summary>
		...
		/// <returns>Value converted as decimal if exists, null otherwise.</returns>
		...
		public static decimal? GetDecimalNullable(this System.Data.Common.DbDataReader dbDataReader, int columnOrdinal)
		{
			...
			return dbDataReader.GetDecimal(columnOrdinal);
		}
		...
		public static decimal? GetDecimalNullable(this System.Data.Common.DbDataReader dbDataReader, string columnName)
		{
			...
			return dbDataReader.GetDecimalNullable(columnOrdinal);
		}
	}
}
