...
{
	/// <summary>
	/// Static class with methods to read data as string.
	/// </summary>
	public static class StringExtensions
	{
		/// <summary>
		/// Extension method to get string value from reader.
		/// </summary>
		...
		/// <returns>Value converted as string if exists, null otherwise.</returns>
		...
		public static string? GetStringNullable(this System.Data.Common.DbDataReader dbDataReader, int columnOrdinal)
		{
			...
			return dbDataReader.GetString(columnOrdinal);
		}
		...
		public static string? GetStringNullable(this System.Data.Common.DbDataReader dbDataReader, string columnName)
		{
			...
			return dbDataReader.GetStringNullable(columnOrdinal);
		}
	}
}
