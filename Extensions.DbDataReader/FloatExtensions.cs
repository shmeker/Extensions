...
{
	/// <summary>
	/// Static class with methods to read data as float.
	/// </summary>
	public static class FloatExtensions
	{
		/// <summary>
		/// Extension method to get float value from reader.
		/// </summary>
		...
		/// <returns>Value converted as float if exists, null otherwise.</returns>
		...
		public static float? GetFloatNullable(this System.Data.Common.DbDataReader dbDataReader, int columnOrdinal)
		{
			...
			return dbDataReader.GetFloat(columnOrdinal);
		}
		...
		public static float? GetFloatNullable(this System.Data.Common.DbDataReader dbDataReader, string columnName)
		{
			...
			return dbDataReader.GetFloatNullable(columnOrdinal);
		}
	}
}
